...
from src.meldataset import MelDataset, mel_spectrogram, get_dataset_filelist
...
from generator import get_static_generator
...
def train(rank, a, h):
    ...
    generator = get_static_generator().to(device)
    ...
    if rank == 0:
        validset = WaveDataset(validation_filelist, h.segment_size, h.sampling_rate, False, n_cache_reuse=0,
                               fine_tuning=a.fine_tuning)
