...
def generate_sniffers_by_example(example_item, cache_hook=lambda k, x: x(), hiddens=[1092, 546, 364], one_hot=False):
    sniffers_configs = generate_sniffers_configs_by_example(example_item, hiddens=hiddens, one_hot=one_hot)
