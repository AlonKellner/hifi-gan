...
class NoiseAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, noise_type):
...
class RirAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, aug_parameter):
...
class LowpassAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, aug_parameter):
        wav = wav.unsqueeze(0)
        wav, sr = sox_effects.apply_effects_tensor(wav, self.sample_rate, [['lowpass', '-1', aug_parameter]])
        wav = wav.squeeze(0)
        return labels, wav, aug_parameter
...
class HighpassAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, aug_parameter):
        wav = wav.unsqueeze(0)
        wav, sr = sox_effects.apply_effects_tensor(wav, self.sample_rate, [['highpass', '-1', aug_parameter]])
        wav = wav.squeeze(0)
        return labels, wav, aug_parameter
...
class ReverbAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, aug_parameter):
        wav = wav.unsqueeze(0)
        wav, sr = sox_effects.apply_effects_tensor(wav, self.sample_rate, [['reverb', '-w']])
        wav = wav.squeeze(0)
        wav = wav[0]
        return labels, wav, aug_parameter
...
class HilbertAugmentor:
    ...
    def augment(self, labels, cut_labels, wav, aug_parameter):
        wav = wav.unsqueeze(0)
        wav, sr = sox_effects.apply_effects_tensor(wav, self.sample_rate, [['hilbert']])
        wav = wav.squeeze(0)
        return labels, wav, aug_parameter
